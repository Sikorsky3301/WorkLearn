...
export default function UniversityLogin() {
  ...
  const handleSubmit = async (e) => {
    ...
    const result = loginUniversity(rollNo, password)
    setLoading(false)
  ...
  const fillMentor = () => {
    setRollNo('MENTOR001'); setPassword('mentor123')
    setInstitution('IIT Delhi'); setDepartment('Computer Science & Engineering (CSE)'); setSection('CS-3A')
  }
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                placeholder="e.g. 21CS001 or MENTOR001"
                required
                className="input w-full font-mono"
              />
              <p className="text-[11px] text-on-surface-variant mt-1">Mentors: use your Mentor ID provided by admin.</p>
            </div>
          ...
          <div className="mt-6 p-4 bg-surface-low rounded-xl border border-border">
            ...
            <div className="space-y-2">
              ...
              <button
                ...
                className="w-full text-left px-3 py-2.5 rounded-lg hover:bg-white border border-transparent hover:border-border transition-colors"
              >
                <p className="text-xs font-semibold text-on-surface">Class Mentor — Prof. Ananya Sharma</p>
                <p className="text-[11px] font-mono text-on-surface-variant mt-0.5">ID: MENTOR001 · IIT Delhi · CSE-3A · Password: mentor123</p>
              </button>
            </div>
          </div>
