    ...
    <header className="sticky top-0 z-50 bg-white border-b border-border">
      ...
      <div className="max-w-container mx-auto px-6 flex items-center gap-1" style={{ height: 52 }}>
        ...
        <div className="ml-auto flex items-center gap-2.5">
          ...
          {/* Avatar → Settings */}
          <button onClick={() => navigate('/settings')} className="w-8 h-8 bg-primary rounded-full flex items-center justify-center hover:opacity-90 transition-opacity" title={user?.name || 'Profile'}>
