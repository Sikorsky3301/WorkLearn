...
import { useAdminSimulation, useCreateTask, useDeleteTask, useDuplicateTask, useReorderTasks, useUpdateSimulation } from '../../../../shared/api/hooks'
...
export default function StagesTab({ simId }) {
  ...
  const [editorWidth, startEditorResize] = useResizableWidth({ initial: 280, min: 240, max: 480, reverse: true })
