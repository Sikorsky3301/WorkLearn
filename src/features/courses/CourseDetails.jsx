...
function LumenLogo({ size = 36 }) {
  return (
    <div
      style={{ width: size, height: size, borderRadius: size * 0.28 }}
      className="bg-gradient-to-br from-orange-400 to-orange-600 flex items-center justify-center shrink-0 shadow-sm"
    >
      <svg viewBox="0 0 20 22" fill="none" style={{ width: size * 0.52, height: size * 0.52 }}>
