...
import { Mail, Lock, Eye, EyeOff, AlertCircle, Loader2, ShieldCheck, Users2, Activity } from 'lucide-react'
import { useAuth } from '../AuthContext'
import logo from '../../../assets/logo.png'

const TRUST_POINTS = [
  { Icon: Users2, text: 'Manage learners — view, search, and moderate accounts' },
  { Icon: Activity, text: 'Monitor platform activity within your granted permissions' },
  { Icon: ShieldCheck, text: 'Scoped access — you can only do what your role explicitly allows' },
]

/** Admin portal's own login, separate from Super Admin's (see
 * SuperAdminLogin.jsx) — hits POST /api/auth/login/admin, a distinct
 * backend-verified role check from login/superadmin. */
        ...
        <div className="relative z-10 flex flex-col justify-between p-12 text-white w-full">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-white/60 text-xs leading-tight">Admin Portal</p>
            </div>
          </div>
          ...
          <div className="max-w-sm">
            ...
            <p className="text-white/70 text-sm leading-relaxed mb-8">
              Sign in with your admin credentials — your dashboard shows exactly what your
              assigned role grants access to.
            </p>
          ...
          <p className="text-white/40 text-xs">
            Access is restricted to authorized admins. All activity is logged.
          </p>
        </div>
      </div>
        ...
        <div className="w-full max-w-sm">
          <div className="lg:hidden flex items-center gap-3 mb-8 justify-center">
            ...
            <div>
              ...
              <p className="text-on-surface-variant text-xs leading-tight">Admin Portal</p>
            </div>
          </div>
          ...
          <div className="mb-7">
            ...
            <p className="text-sm text-on-surface-variant">Sign in with your admin account to continue.</p>
          </div>

          <form onSubmit={handleSubmit} noValidate className="space-y-4">
            <div>
              <label htmlFor="admin-portal-email" className="text-xs font-semibold text-on-surface-variant block mb-1.5">
                Email address
              </label>
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                <label htmlFor="admin-portal-password" className="text-xs font-semibold text-on-surface-variant">
                  Password
                </label>
              </div>
              <div className="relative">
