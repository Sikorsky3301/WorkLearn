 ...
 * AdminPortalLogin.jsx) — hits POST /api/auth/login/superadmin. Same
 * split-screen shape as the main Login.jsx: a scrollable form on the left,
    ...
    <div className="h-screen flex overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto flex items-center justify-center px-8 py-6 bg-white">
        <div className="w-full max-w-sm">
          ...
          <h1 className="text-2xl font-bold text-on-surface mb-1">Super Admin sign in</h1>
          ...
          <form onSubmit={handleSubmit} noValidate className="space-y-3">
            <div>
              <label htmlFor="super-admin-email" className="text-xs font-semibold text-on-surface block mb-1.5">
                Email address
              </label>
            ...
            <div>
              <label htmlFor="super-admin-password" className="text-xs font-semibold text-on-surface block mb-1.5">
                Password
              </label>
              <div className="relative">
      ...
      {/* ── Right: single hero image, shown at up to its true native pixel
          size (736×1098) and never upscaled beyond that — object-contain
          ...
          blur. #0c158a is the image's own dominant blue, sampled directly
          from it, so any letterboxed space above/below reads as part of
          the same palette rather than a mismatched bar. ── */}
      <div className="hidden lg:flex lg:w-1/2 h-full items-center justify-center bg-[#0c158a] overflow-hidden p-10">
        <img
          src="/images/superadmin-abstract.jpg"
          alt=""
          width={736}
          height={1098}
